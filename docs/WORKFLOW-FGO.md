...
3. **SpriteFrames**: `tools/make_frames_tres.ps1` genera los `.tres` (idle loop 15fps, attack 30, cast 15, hurt/die 30; die = hurt).
...
4. Iconos de powers = iconos de skill FGO; reliquias = iconos de item (con `_outline` = silueta blanca del alpha): `tools/make_icons.ps1`.
