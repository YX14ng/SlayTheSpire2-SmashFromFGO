...
/// <summary>
/// Colmillo del Búho — 12 de daño (el ataque honesto sin condiciones del pool).
/// </summary>
public sealed class OwlsFang() : ArtoriaCard(1, CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)
{
