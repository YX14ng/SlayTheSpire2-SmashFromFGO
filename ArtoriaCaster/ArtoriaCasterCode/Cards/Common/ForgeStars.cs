...
/// <summary>Forjar Estrellas — Habilidad 1⚡: ganás 2★; robás 1 carta.</summary>
public sealed class ForgeStars() : ArtoriaCard(1, CardType.Skill, CardRarity.Common, TargetType.Self)
{
