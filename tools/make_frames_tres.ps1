# Regenera los SpriteFrames .tres de las 3 formas desde las carpetas de frames (webp).
$dir = "f:\Programs\SlayTheSpire2-SmashFromFGO\MashShielder\MashShielder\character"
$res = "res://MashShielder/character"
...
New-FramesTres "frames" "mash_frames_base.tres"
New-FramesTres "frames_ortinax" "mash_frames_ortinax.tres"
New-FramesTres "frames_paladin" "mash_frames_paladin.tres"
Write-Output "LISTO"
