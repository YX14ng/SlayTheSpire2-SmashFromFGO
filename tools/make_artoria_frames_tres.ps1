# Regenera los SpriteFrames .tres de las 3 formas de Artoria desde las carpetas de frames (webp).
$dir = "f:\Programs\SlayTheSpire2-SmashFromFGO\ArtoriaCaster\ArtoriaCaster\character"
