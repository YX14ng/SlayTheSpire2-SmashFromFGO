...
/// <summary>
/// Corte Ascendente (上斩) — DESIGN-OKITA §5.2. 1⚡ At: 7 daño; +10 Carga NP (up: 10 / +10).
/// NP pan y manteca.
/// </summary>
public sealed class RisingCut() : OkitaCard(1, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
{
