...
/// <summary>
/// Kiku-ichimonji (菊一文字) — DESIGN-OKITA §5.3. 1⚡ At: 12 daño (up: 16). Su katana: pan y manteca pc.
/// </summary>
public sealed class KikuIchimonji() : OkitaCard(1, CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)
{
