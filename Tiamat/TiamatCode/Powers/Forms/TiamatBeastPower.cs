...
/// <summary>
/// Forma Dracónica (Bestia II) — la DEVORADORA. Amplifica la Maldición que aplicás (+1,
/// ICurseAmplifier) y esparce Marea sola: al inicio de tu turno aplica +1 Maldición a un
/// enemigo. Es la forma clímax donde el enjambre ya criado se vuelve daño (se entra por la
/// ventana de NP "Génesis"). Rediseño 2026-06-13.
/// </summary>
public sealed class TiamatBeastPower : TiamatFormPower, ICurseAmplifier
{
