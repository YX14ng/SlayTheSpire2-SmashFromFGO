...
public sealed class CrownOfThePeerless() : SiegfriedCard(3, CardType.Power, CardRarity.Rare, TargetType.Self)
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        // |= (audit 2026-07-04): una copia base tras la mejorada le quitaba el rider de +5 NP al power.
        if (power != null) await power.Configure(choiceContext, IsUpgraded, this);
    }
}
