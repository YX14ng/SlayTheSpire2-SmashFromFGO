...
/// <summary>麻婆豆腐 — extremely spicy. Restores the soul, hurts the tongue.</summary>
public sealed class MapoTofu() : MemeCard(1, CardType.Skill, CardRarity.Common, TargetType.Self)
{
