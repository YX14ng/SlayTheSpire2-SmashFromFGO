...
/// <summary>
/// A relic/power on the owner that can let an incoming hit PIERCE part of its
...
/// attack) and bypasses one point of reduction if any returns <c>true</c>.
///
...
{
    /// <summary>True if this reaching hit should bypass one point of Dragon Scales.</summary>
